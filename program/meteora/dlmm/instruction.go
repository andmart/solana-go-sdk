...
const (
	METEORA_DLMM_PROGRAM_ADDRESS = "LBUZKhRxPF3XUpBCjp4YzTKgLccjZhTSDM9YuVaPwxo"
)
...
func SwapBaseInInstruction(param meteora.MeteoraSwapInstructionParam) types.Instruction {
	...
	return types.Instruction{common.PublicKeyFromString(METEORA_DLMM_PROGRAM_ADDRESS), param.Accounts, data}
}
